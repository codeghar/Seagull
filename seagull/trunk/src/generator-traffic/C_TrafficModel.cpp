...
void C_TrafficModel::update ()
{
  ...
  // Update, if necessary, the start of the current period date
  // (P2) if (m_currentPeriodDuration > (m_periodDuration*1000)) 
...
int C_TrafficModel::authorize_new_call ()
{
  ...
  GEN_DEBUG(0, "Current Period Duration (ti-tp)           : " << m_currentTrafficDuration << " ms");
