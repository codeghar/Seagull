...
#ifndef _C_PROTOCOLTLV_
#define _C_PROTOCOLTLV_
...
class C_ProtocolTlv : public C_ProtocolBinaryFrame {
...
public:
  ...
  typedef struct _struct_protocol_counter_data {
    int            m_id              ;
    int            m_start_id        ;
    int            m_stop_id         ;
  } T_ProtocolCounterData, *T_pProtocolCounterData ;
  typedef list_t<T_ProtocolCounterData> T_ProtocolCounterDataList, *T_pProtocolCounterDataList ;  
  ...
  typedef struct _struct_update_ctxt_value {
    int          m_nb_ctxt_id     ;
    int         *m_ctxt_id_setted ;
  } T_UpdateCtxtValue , *T_pUpdateCtxtValue ;

  typedef struct _struct_update_ctxt_position {
    int          m_nb_ctxt_pos ;
    int          m_ctxt_id_pos ;
  } T_UpdateCtxtPosition , *T_pUpdateCtxtPosition ;
  ...
  void               update_ctxt_values (C_ProtocolContext     *P_protocol_context,
  ...
  int   update_ctxt_values_decode (C_ProtocolContext     *P_protocol_context,
                                   int                    P_field_id,
                                   int                    P_size,
                                   T_pUpdateCtxtValue     P_ctxt_id_v_table) ;
  ...
  typedef T_pValueData (C_MessageTlv::*T_SessionMethodTlv)(C_ContextFrame *P_void);
  int  get_m_session_id_id() ;
  T_SessionMethodTlv get_m_session_method() ;


protected:


  typedef map_t<string_t, int> T_LengthIdMap, *T_pLengthIdMap ;
  typedef list_t<int> T_IdCtxtList, *T_pIdCtxtList ;
  ...
  int  update_ctxt_v_field (T_pUpdateCtxtValue      P_ctxt_id_v_table, 
                            int                     P_nb_field,
...
//    int  update_ctxt_p_field (T_pUpdateCtxtPosition   P_ctxt_id_p_table,
//                              T_pProtocolCounterData  P_ctxt_table,
//                              int                     P_nb_ctxt_table);
    
  int ctrl_length  (char *P_length_name, bool P_header) ;

  int update_field_length (int                        P_length_id,
                           int                        P_field_id, 
                           T_pProtocolCounterDataList P_length_list,
                           bool                       P_header) ;


  void               propagate_ctxt_local (C_ProtocolContext         *P_protocol_context,
                                           int                        P_id_begin,
                                           int                        P_id_end,
  ...
  void  update_ctxt_length (C_ProtocolContext  *P_protocol_context,
                            unsigned long       P_valueSize);


  int  update_ctxt_length_decode (C_ProtocolContext *P_protocol_context,
  ...
  int                          m_session_id_id             ;
  bool                         m_use_open_id               ;
  T_SessionMethodTlv           m_session_method            ;
