...
#ifndef _C_LOGPROTOCOLSTATCONTROL_H
#define _C_LOGPROTOCOLSTATCONTROL_H
...
class C_LogProtocolStatControl : public C_TaskControl {

 public:

  C_LogProtocolStatControl(C_ProtocolStatsFrame *P_stats) ;
...
#endif // _C_LOGPROTOCOLSTATCONTROL_H
