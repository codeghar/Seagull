...
int crypto_args_analysis (T_pValueData  P_args, T_pCryptoArgsStr P_result) {
  ...
  P_result->m_user = NULL ; 
  P_result->m_password = NULL ; 
  P_result->m_method = NULL ;
  P_result->m_uri = NULL ; 
  P_result->m_auth = NULL ; 
  P_result->m_algo_id = -1 ;
  P_result->m_algo  = NULL ;
  P_result->m_aka_k  = NULL ;
  P_result->m_aka_op  = NULL ;
  P_result->m_aka_amf  = NULL ;
