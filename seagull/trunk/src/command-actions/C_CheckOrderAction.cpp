...
C_CheckOrderAction::C_CheckOrderAction(T_CmdAction        P_cmdAction,
                                       T_pControllers P_controllers)
  : C_CommandAction (P_cmdAction, P_controllers) {
}

C_CheckOrderAction::~C_CheckOrderAction() {
}


T_exeCode    C_CheckOrderAction::execute(T_pCmd_scenario P_pCmd,
