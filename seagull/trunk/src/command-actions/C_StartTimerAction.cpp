...
C_StartTimerAction::C_StartTimerAction(T_CmdAction        P_cmdAction,
                                       T_pControllers P_controllers)
  : C_CommandAction (P_cmdAction, P_controllers) {
}


C_StartTimerAction::~C_StartTimerAction() {
}


T_exeCode    C_StartTimerAction::execute(T_pCmd_scenario P_pCmd,
