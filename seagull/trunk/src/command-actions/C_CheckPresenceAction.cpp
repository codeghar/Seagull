...
C_CheckPresenceAction::C_CheckPresenceAction(T_CmdAction        P_cmdAction,
                                             T_pControllers P_controllers)
  : C_CommandAction (P_cmdAction, P_controllers) {
}


C_CheckPresenceAction::~C_CheckPresenceAction() {
}


T_exeCode    C_CheckPresenceAction::execute(T_pCmd_scenario P_pCmd,
