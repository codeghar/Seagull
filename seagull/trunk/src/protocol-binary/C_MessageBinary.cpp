...
T_pValueData C_MessageBinary::get_out_of_session_id () {
  ...
  GEN_DEBUG(1, "C_MessageBinary::get_out_of_session_id() start");
  ...
  case C_ProtocolBinary::E_MSG_ID_HEADER:
	...
	== E_TYPE_STRING) {
      GEN_DEBUG(1, "C_MessageBinary::get_out_of_session_id() reset PB");
  ...
  GEN_DEBUG(1, "C_MessageBinary::get_out_of_session_id() end");
